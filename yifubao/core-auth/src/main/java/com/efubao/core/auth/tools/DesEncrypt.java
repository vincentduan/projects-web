...
public class DesEncrypt {
	...
	public String encrypt(String strMing) {
		...
		try {
			...
			throw new RuntimeException("DES encrypt error. Cause: " + e);
		} finally {
			base64en = null;
			byteMing = null;
			byteMi = null;
	...
	private byte[] getEncCode(byte[] byteS) {
		...
		try {
			...
			throw new RuntimeException("DES getEncCode error. Cause: " + e);
		} finally {
			cipher = null;
		}
		return byteFina;
	...
	private byte[] getDesCode(byte[] byteD) {
		...
		try {
			...
			throw new RuntimeException("DES getDesCode error. Cause: " + e);
		} finally {
			cipher = null;
		}
		return byteFina;
	...
	public static void main(String args[])  {
		...
		String str = "xv3U/I8aazM=";
		String deStr = des.decrypt(str);
