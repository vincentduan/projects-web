    ...
    <div class="cont">
      <div class="w">
        <div class="wrap">
          <div class="zhengwen">
            <div class="leirong">
              <p class="leirong_1">已完成订单</p>
              <div class="public">
                <p><label><span class="back_1 on">金额：￥60000.00</span>
                <span class="back_2 "><img src="<%=basePath%>resources/images/icon24.png">已支付金额￥60000.00</span></label>
                <i>订单号：11884720705</i><i>状态：<em>已完成</em></i>
