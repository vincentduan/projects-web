        ...
        <div class="wrap">
          <div class="zhengwen">
            ...
            <div class="leirong">
              ...
              <p class="leirong_1">已取消订单</p>
              
              <p class="leirong_2"><span>订单号：11884720705</span><span>状态：<font>交易取消</font></span></p>
              ...
              <div class="zhuangtai">
                <div class="div_item">
                  ...
                  <div class="item in on">
                    <div class="list">
                      ...
                      <div class="tanchuan">
                        <div class="tanchuan_text" style="padding:5px 20px">
                          <p>订单总额：<a style="color:#f4444">60,000</a>元<br/>
                          	待支付定金：<a style="color:#f4444">50,000</a>元</p>
                          </div>
                          <div style="position:absolute;left:44px;;margin-top: 1px">
                            <img src="<%=basePath%>resources/images/xiangxia.png"/>
                          </div>
                        </div>
                ...
                <div class="lr_taggle">
                  ...
                  <div class="togg_cont">
                    <div class="taggle">
                      <div class="kehuinfo">
                        <p><span><img src="<%=basePath%>resources/images/tou_1.png">客户信息</span><label class="sem " onclick="$('.wansinfo').show();"><a href="#"><img src="<%=basePath%>resources/images/iconfont_1.png" />完善信息</a></label></p>
                      </div>
                      <div class="bor_info">
                        <div class="xiqinfo">
                          <p>姓名：<a>张三</a></p>
                      ...
                      <div class="kehuinfo">
                        <p><span><img src="<%=basePath%>resources/images/ye_1.png">客户定制需求</span><a href="#"><label class="sem " onclick="$('.wsxx').show();"><img src="<%=basePath%>resources/images/iconfont_1.png" />完善定制需求</label></a></p>
                      </div>
                      <div class="dingzfs">
                        ...
                        <p><span>商品名称</span>：<label class="col"><img src="<%=basePath%>resources/images/list1.png" />男士双排扣西服 XX面料 蓝色 <a href="#">  查看商品详情 >></a></label></p>
                      </div>
      ...
      <div class="wsxx_page1">
        <div class="wsxx_page2">
          ...
          <div class="txt">
            ...
            <p><span>定制数量：</span><label><input type="text"><span>件</span></label></p>
            <p><span>定制数量：</span><label><input type="text"><span>元</span></label></p>
            <p><span>定制数量：</span><label><input type="text"><span>个工作日<em>（量体结束后15个工作日完成生产制作）</em></span></label></p>
            <p><span>定制品类：</span><label><select><option value="1">西服正装</option></select></label></p>
            <p class="text"><span>定制品类：</span><label><textarea id="textarea" onKeyDown="textdown(event)"
    onKeyUp="textup()" onfocus="if(value=='如面料属性、颜色、版号等'){value=''}"
    onblur="if (value ==''){value='如面料属性、颜色、版号等'}">如面料属性、颜色、版号等</textarea></label></p>
            <p class="last"><span>定制品类：</span><label><img src="<%=basePath%>resources/images/list1.png"><span>男士双排扣西服 XX面料 蓝色</span><a>删除</a></label></p>
          <div class="ak">
            <a>保&nbsp;&nbsp;存</a>
          </div>
          </div>
