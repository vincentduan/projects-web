        ...
        <div class="wrap">
          <div class="zhengwen">
            <div class="leirong">
              ...
              <div class="public">
                <p><label><span class="back_1 on">金额：￥60000.00</span>
                <span class="back_2 "><img src="<%=basePath%>resources/images/icon24.png">已支付金额￥50000.00</span>
                </label>
                <i>订单号：11884720705</i><i>状态：<em>支付尾款</em></i>
              ...
              <div class="zhuangtai">
                <div class="div_item">
                  ...
                  <div class="item in on">
                    <div class="list">
                      ...
                      <div class="tanchuan">
                        ...
                        <div class="tanchuan_text">
                          <p>中标服务商<br />
                            <a style="color:#f04444">依文服饰股份有限公司</a></p>
                          </div>
                      </div>
                  ...
                  <div class="item on">
                    ...
                    <div class="item in on">
                      ...
                      <div class="tanchuan">                          
                        <div class="tanchuan_text" style="padding:0px 20px">
	                        <p>订单总额：<a style="color:#f4444">60,000</a>元<br/>
							已支付定金：<a style="color:#f4444">50,000</a>元<br/>
							待支付尾款：<a style="color:#f4444">10,000</a>元</p>
                          </div>
               ...
               <div class="lr_taggle">
                              <div class="togg_list">
                                  <span>定制需求</span>
                                  <span>合同</span>
                                  <span class="on">量体信息</span>
                                  <div class="clear"></div>
                              </div>
                              <div class="togg_cont">
                                  <div class="taggle none">
                                      <div class="kehuinfo">
                                          <p><span><img src="<%=basePath%>resources/images/tou_1.png">客户信息</span></p>
                                      </div>
                                      <div class="bor_info">
                                          <div class="xiqinfo">
                                              <p>姓名：<a>张三</a></p>
                                      ...
                                      <div class="kehuinfo">
                                          <p><span><img src="<%=basePath%>resources/images/ye_1.png">客户定制需求</span></p>
                                      </div>
                                      <div class="dingzfs">
