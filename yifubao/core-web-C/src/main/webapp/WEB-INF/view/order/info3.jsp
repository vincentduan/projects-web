...
$(function() {  
	$.ajax( {  
        type : "get",  
        url : "<%=basePath%>publishOrder/orderCustomerInfoVo?orderNo=${orderNo }",
        dataType:"json",  
	...
	$.ajax( {  
        type : "get",  
        url : "<%=basePath%>publishOrder/orderCustomDemandVo?orderNo=${orderNo }",
					dataType : "json",
					success : function(msg) {
...
<div class="lr_taggle">
	<div class="togg_list">
		<span class="on">定制需求</span> <span>合同</span> <span>量体信息</span>
		<div class="clear"></div>
	</div>
	<div class="togg_cont">
		<div class="taggle">
			...
			<div class="page_size">
				<p>
					<span><a href="#">首页</a></span> <a href="#">1</a> <a href="#"
						class="on">2</a> <a href="#">3</a> <a href="#">4</a> <a href="#">5</a>
					<a href="#">6</a> <a href="#">...</a> <span><a href="#">下一页</a></span>
					<span><a href="#">末页</a></span> <span>共<label>8</label>页<label>64</label>条
					</span>
				</p>
			</div>
			<div class="download">
