               ...
               <div class="zhengwen">
					<div class="leirong">
						...
						<div class="dingzfs">
							...
							<p><span>定制数量</span>：<label>${OrderCustomDemandVo.count=='0'?'未填写':OrderCustomDemandVo.count }</label></p>
    	...
    	<div class="wsxx_page1">
    		<div class="wsxx_page2">
    			...
    			<div class="txt">
    				...
    				<p><span>定制品类：</span><label><select name=""><option value="3">西服正装</option></select></label></p>
    				<p class="text"><span>定制属性：</span><label><textarea id="textarea" onKeyDown="textdown(event)"
    onKeyUp="textup()" onfocus="if(value=='如面料属性、颜色、版号等'){value=''}"
    onblur="if (value ==''){value='如面料属性、颜色、版号等'}">如面料属性、颜色、版号等</textarea></label></p>
    				<p class="last"><span>定制品类：</span><label><img src="../img/list1.png"><span>男士双排扣西服 XX面料 蓝色</span><a>删除</a></label></p>
    			<div class="but_go">
