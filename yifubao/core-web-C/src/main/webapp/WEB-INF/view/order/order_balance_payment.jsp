			...
			<div class="wrap">
				...
				<div class="zhengwen">
					...
					<div class="leirong">
						...
						<div class="public">
							<p>
								<label><span class="back_1 on">金额：￥60000.00</span><span
									class="back_2 "><img
										src="<%=basePath%>resources/img/icon24.png">已支付金额￥60000.00</span></label><i>订单号：11884720705</i><i>状态：<em>支付尾款</em></i><a
									href="<%=basePath %>payOrder/payBalance_payment?orderNo=${orderNo }">支付尾款：￥36000.00</a>
							</p>
						</div>
