              ...
              <div class="daohang">
               ...
               <div class="zhengwen">
					<div class="leirong">
						...
						<p class="leirong_2"><span>订单号：${baseOrder.orderNo }</span><span>状态：${orderStatusMap[baseOrder.status] }</span></p>
						<div class="zhuangtai">
							<div class="div_item">
							 ...
							 <%--  <c:forEach items="${orderStream }" var="item">
							  <c:if test="${item.status < orderNo.status}">
							  ...
							  <div class="item"><div class="list"><i></i><p>待发货</p></div></div>
							  <div class="item"><div class="list"><i></i><p>待签收</p></div></div>
							  <div class="item"><div class="list"><i></i><p>交易完成</p></div></div>
							  </c:if>
							  <c:if test="${orderNo.status=='150' }">
							  <c:forEach items=""></c:forEach>
							  <div class="item on"><div class="list"><i></i><p>管家受理</p></div></div>
							  <div class="item"><div class="list"><i></i><p>选择服务商</p><span class="span1">(设计、打样、报价)</span></div></div>
							  <div class="item"><div class="list"><i></i><p>签单订金</p></div></div>
							  ...
							  <c:if test="${orderNo.status=='190'||orderNo.status=='200'  }">
							  <c:forEach items=""></c:forEach>
							  <div class="item on"><div class="list"><i></i><p>管家受理</p></div></div>
							  <div class="item"><div class="list"><i></i><p>选择服务商</p><span class="span1">(设计、打样、报价)</span></div></div>
							  <div class="item"><div class="list"><i></i><p>签单订金</p></div></div>
							  ...
							  <div class="item"><div class="list"><i></i><p>交易完成</p></div></div>
								...
								<div class="item on">
									<div class="list">
										<i></i>
										<p>${orderStatusMap[baseOrder.status] }</p>
										<div class="tanchuan">
											<div class="tanchuan_img">
												<img src="<%=basePath%>resources/img/yaoyingchao.png"/>
												<div class="sanjia">
								...
								<div class="list">
										<i></i>
										<p>${orderStatusMap[item.status] }</p>
								</div>
								</c:if>
								</c:forEach> --%>
								<!-- <div class="item on">
    ...
    <div class="wsxx">
    	<div class="wsxx_page1">
    		<div class="wsxx_page2">
    			...
    			<form id="form_2" action="/core-web-C/publishOrder/editGoodsInfo">
    			<div class="txt">
		...
		<div class="windows">
			...
			<div class="tianxie">
				<div class="detailed">
					...
					<div class="tianxie_1">
					<form id="form_3" action="/core-web-C/publishOrder/editUInfo">
					    <input type="hidden" name="orderNo" value="${baseOrder.orderNo }">
						<div class="deta">
