...
<script type="text/javascript" src="${ctxStatic}/bootstrap-datetimepicker/js/bootstrap-datetimepicker.js" charset="UTF-8"></script>
...
<!--[if lt IE 9]>
<script src="${ctxStatic}/common/html5shiv.min.js"></script>
...
<script src="${ctxStatic}/common/unisktools.js" type="text/javascript"></script>
...
<link href="${ctxStatic}/common/emvc.min.css" type="text/css" rel="stylesheet" />
<script src="${ctxStatic}/common/emvc.min.js" type="text/javascript"></script>
<link href="${ctxStatic}/common/app.css" type="text/css" rel="stylesheet" />
