...
public abstract class CustomerBaseBuilder {
	protected final CustomerConfiguration configuration;
	protected final TypeAliasRegistry typeAliasRegistry;
	protected final TypeHandlerRegistry typeHandlerRegistry;

	public CustomerBaseBuilder(CustomerConfiguration configuration) {
