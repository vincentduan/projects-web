...
/**
 * 
 * @Description:沃众筹微信应用总入口
 * @author shijingbang
 * @Date 2015年11月18日
 */
public class WechatAttentionHttpServlet extends HttpServlet {

	private static final long serialVersionUID = 6048046908867524260L;

	private static final Logger logger = LoggerFactory.getLogger(WechatAttentionHttpServlet.class);
	private static final String WX_BIZ_MSG_CRYPT = "assistantMsgCrypt";
