package com.unisk.wechat.api.official.sdk;
...
/**
 * 代码下载地址：http://qydev.weixin.qq.com/wiki/index.php?title=加解密库下载与返回码
 * 
 * @Description:微信官网提供的代码 <br/>
 * 
 * @author shijingbang
 * @Date 2015年11月18日
 */
public class OfficialApiSample {
